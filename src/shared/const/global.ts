...
export const privateKeyFile = `${keysDir}/key`
export const publicKeyFile = `${keysDir}/key.pub`
...
export const publicKeyLineCount = 13
// Diffie-Hellman Group 16 as specified in RFC 3526
export const diffieHellmanPrime = Buffer.from(
  `
...
export const diffieHellmanGenerator = Buffer.from('2', encoding)
export const pbkdf2SyncPasses = 10000
export const pbkdf2HashAlgorithm = 'sha256'
